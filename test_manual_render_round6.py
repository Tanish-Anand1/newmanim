...
class SumOfOdds(Scene):
    def construct(self):
        ...
        # Split into unique substrings for clean TransformMatchingShapes
        ...
        self.play(FadeIn(dots2), TransformMatchingShapes(eq1, eq2, fade_transform_mismatches=True))
        self.wait(1)
        ...
        self.play(FadeIn(dots3), TransformMatchingShapes(eq2, eq3, fade_transform_mismatches=True))
        self.wait(1)
        ...
        self.play(FadeIn(dots4), TransformMatchingShapes(eq3, eq4, fade_transform_mismatches=True))
        self.wait(2)
